...
extern PGresult *PQexecBCTx(PGconn *conn, const char *query);
extern int PQsendBCTx(PGconn *conn, const char *query);
extern int PQBCSendDummy(PGconn *conn, const char *file_path);
