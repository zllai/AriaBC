...
typedef enum
{
	...
	WAIT_EVENT_SYNC_REP,
	WAIT_EVENT_EXEC_WRITE_SET,
	WAIT_EVENT_BLOCK_COMMIT,
	WAIT_EVENT_TX_FINISH,
	WAIT_EVENT_TX_READY_TO_COMMIT,
	WAIT_EVENT_OTHER_BLOCK_FINISH,
	WAIT_EVENT_SNAPSHOT_READY
} WaitEventIPC;
