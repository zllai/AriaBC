...
extern void SetCurrentTransactionState(TransactionState tx_state);
extern void AttachTopTransactionState(TransactionState tx_state);
extern TransactionState DetachTopTransactionState(void);
extern void ResetTopTransactionState(void);
